...
namespace DbMigrations.Migrations
{
    ...
    [Migration("20211206203951_FixedTokenFieldName")]
    partial class FixedTokenFieldName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.CandidateProcesEntityModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.CandidateProcessTestTaskEntityModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.UserCandidateSandboxEntityModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserCandidateSandboxes");
                });
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.CandidateProcessTestTaskEntityModel", b =>
                {
                    b.HasOne("DbMigrations.EntityModels.CandidateProcesEntityModel", "СandidateProcess")
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.FeedbackEntityModel", b =>
                {
                    b.HasOne("DbMigrations.EntityModels.CandidateProcesEntityModel", "CandidateProcces")
                        .WithMany("Feedbacks")
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.UserCandidateSandboxEntityModel", b =>
                {
                    b.HasOne("DbMigrations.EntityModels.CandidateSandboxEntityModel", "CandidateSandbox")
                        .WithMany("UserCandidateSandboxes")
                        .HasForeignKey("CandidateSandboxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DbMigrations.EntityModels.CandidateSandboxEntityModel", b =>
                {
                    ...
                    b.Navigation("UserCandidateSandboxes");
                });
